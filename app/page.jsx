              ...
              <div className={styles.imgContainer}>
                ...
                <div className={styles.social}>
                  <div className={styles.box}>
                    ...
                    <Link href="https://www.dilipmaurya.in" target="_blank" aria-label="My Website" >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
        ...
        <section className={styles.contact} id="contact">
          <div className={styles.container}>
            <div className={styles.details}>
              ...
              <div className={styles.social}>
                <div className={styles.box}>
                  <Link href="https://www.linkedin.com/in/curiousdilip/"  target="_blank" aria-label="Linkedin">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="18"
                      height="18"
                  ...
                  <Link href="https://www.github.com/curiousdilip/" target="_blank" aria-label="Github">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="18"
                      height="18"
                  ...
                  <Link href="https://www.twitter.com/curiousdilip/" target="_blank" aria-label="Twitter">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="18"
                      height="18"
